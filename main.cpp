...
int main(int argc, const char * argv[]) {
    ...
    Node** board = boardConstructor(numberArray[0]);
    
    Object* object1 = objectConstructor(numberArray[5], numberArray[6], numberArray[7], numberArray[8], numberArray[9]);
    
    Object* object2 = objectConstructor(numberArray[10], numberArray[11], numberArray[12], numberArray[13], numberArray[14]);
    ...
    for(i=0;i<numberArray[0];i++) {
        ...
        for(j=0;j<numberArray[0]; j++){
            ...
            printf("%c", board[j][i].visualRepresentation);
